...
from nengo.params import (EnumParam, NdarrayParam, NumberParam, Parameter,
                          ShapeParam, TupleParam, Unconfigurable)
...
class PresentJitteredImages(Process):
    ...
    def __init__(self, images, presentation_time, output_shape,
        ...
        import scipy.ndimage.interpolation  # requires this
